...
<div class="span10 last">
			<div class="topNav clearfix">
				<ul>
					...
					<s:else>
					<li id="headerName" class="headerLogin"
						style="display: list-item;"><s:property value="#session.existUser.name" />|</li>
					<li id="headerOrders" class="headerRegister"
						style="display: list-item;"><a href="${pageContext.request.contextPath}/order_findByUid.action?page=1">我的订单</a>|</li>
					<li id="headerQuit" class="headerRegister"
