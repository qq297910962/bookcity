		...
		<div class="span24">
			<div class="step step1">
				...
				<div class="bottom">
					...
					<a href="${pageContext.request.contextPath}/order_submit.action" id="submit" class="submit">提交订单</a>
				</div>
		</div>
		</s:if>
		<s:else>
			<div class="span24">
				<div class="step step1">
					<span><h3 style="color:red">购物车为空！</h3></span>
				</div>	
			</div>
		</s:else>
	</div>
