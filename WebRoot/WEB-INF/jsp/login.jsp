...
<script>
	...
	function changeCheckCode() {
		...
		img.src="${pageContext.request.contextPath}/verificationCode.action?"+new Date().getTime();
	}
						...
						<table>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkCode" name="checkCode" class="text captcha" maxlength="4" autocomplete="off"><img id="checkImage" class="captchaImage" src="${pageContext.request.contextPath}/verificationCode.action" onclick="changeCheckCode()" title="点击更换验证码">
										</span>
									</td>
								</tr>
							<tr>
