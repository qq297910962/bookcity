					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td width="50%" align="center">订单详情</td>
							</tr>
							<s:iterator var="order" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%"><s:if test="#order.state==1">未付款</s:if> <s:if
											test="#order.state==2">
											<a href="${pageContext.request.contextPath}/adminOrder_updateState?oid=<s:property value='#order.oid' />"><font color="blue">发货</font>
											</a>
										</s:if> <s:if test="#order.state==3">确认收货中</s:if> <s:if
											test="#order.state==4">订单完成</s:if></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									...
									<td align="center" style="HEIGHT: 22px"><input
										...
										value="订单详情" onclick="showDetail(<s:property value='#order.oid'/>)" />
